...
/// </summary>
public record class RoutingNearestParams : ParamsBase
{
    ...
    public RoutingNearestParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RoutingNearestParams(RoutingNearestParams routingNearestParams)
        : base(routingNearestParams)
    {
        this._rawBodyData = new(routingNearestParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static RoutingNearestParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(RoutingNearestParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/nearest")
        {
