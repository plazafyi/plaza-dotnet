...
/// </summary>
public record class GeocodeForwardParams : ParamsBase
{
    ...
    public GeocodeForwardParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public GeocodeForwardParams(GeocodeForwardParams geocodeForwardParams)
        : base(geocodeForwardParams)
    {
        this._rawBodyData = new(geocodeForwardParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static GeocodeForwardParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(GeocodeForwardParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/geocode")
        {
