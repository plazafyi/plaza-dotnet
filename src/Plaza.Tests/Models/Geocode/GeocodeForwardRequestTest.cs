...
public class GeocodeForwardRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new GeocodeForwardRequest
        {
        ...
        string expectedQ = "221B Baker Street, London";
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<GeocodeForwardRequest>(
            json,
    ...
    {
        var model = new GeocodeForwardRequest { Q = "221B Baker Street, London" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        GeocodeForwardRequest copied = new(model);
