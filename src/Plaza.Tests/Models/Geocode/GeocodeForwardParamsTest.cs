...
public class GeocodeForwardParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new GeocodeForwardParams
        {
    ...
    {
        GeocodeForwardParams parameters = new()
        {
            Q = "221B Baker Street, London",
            Format = "format",
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        GeocodeForwardParams copied = new(parameters);
